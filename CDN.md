...
The ID is automatically generated by our system. The `.extension` part is optional, meaning that our API will also include it when asking for cdn urls, but the links work even if you ommit it. 
